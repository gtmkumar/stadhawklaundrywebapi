...
{
    public partial class StadhawkLaundryContext : DbContext
    {
        public StadhawkLaundryContext()
        {
        }

        public StadhawkLaundryContext(DbContextOptions<StadhawkLaundryContext> options)
            : base(options)
        {
        }
