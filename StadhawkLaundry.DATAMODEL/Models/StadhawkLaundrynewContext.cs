...
{
    public partial class StadhawkLaundrynewContext : DbContext
    {
        public StadhawkLaundrynewContext()
        {
        }

        public StadhawkLaundrynewContext(DbContextOptions<StadhawkLaundrynewContext> options)
            : base(options)
        {
        }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. See http://go.microsoft.com/fwlink/?LinkId=723263 for guidance on storing connection strings.
                optionsBuilder.UseSqlServer("Server=gtm;Database=StadhawkLaundrynew;User=BhejonaWebUserPP;password=Bhej0n@@97531;Trusted_Connection=false;");
            }
        }
